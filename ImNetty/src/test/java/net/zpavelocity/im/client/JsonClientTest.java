...
import net.zpavelocity.im.client.handler.SimpleJsonMsgHandler;
...
public class JsonClientTest {
    ...
    public JsonClientTest(String USERNAME, String HOST, int PORT) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        int port = 21010;
        new JsonClientTest(username, host, port).start();
